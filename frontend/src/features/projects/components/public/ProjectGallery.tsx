...
export const ProjectGallery: React.FC<{ project: Project }> = ({ project }) => {
    ...
    return (
        <div className="animate-fade-in border-t border-slate-100">
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] bg-black/95 backdrop-blur-md flex items-center justify-center animate-fade-in">
                    <button
                    ...
                    <button
                        ...
                        className="absolute left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 p-4 rounded-full transition-all z-50 hidden md:block"
                    >
                        <FaChevronLeft size={24} />
                    </button>

                    <div className="w-full h-full max-w-7xl max-h-screen p-4 md:p-10 flex flex-col items-center justify-center">
                        ...
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white/80 text-sm font-medium bg-black/50 px-4 py-1 rounded-full backdrop-blur-md">
                    ...
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 p-4 rounded-full transition-all z-50 hidden md:block"
                    >
