                ...
                <div className="w-full xl:w-[55%] flex flex-col justify-center px-6 py-16 md:p-20 xl:py-24 bg-[#1b252f] text-white relative z-10">
                    ...
                    <div className="max-w-2xl mx-auto space-y-16 relative z-10">
                        ...
                        <FadeIn direction="up" delay={0.4}>
                            <div className="bg-gradient-to-r from-orange-900/20 to-transparent p-8 md:p-10 rounded-3xl border border-white/10 border-l-4 border-l-orange-500 flex flex-col xl:flex-row items-center justify-between gap-8 group hover:bg-white/5 transition-colors duration-500">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                    {whatsappLink && (
                                        <a
                                            ...
                                            className="px-8 py-4 bg-emerald-600/20 border border-emerald-500/30 text-emerald-100 text-base font-bold rounded-xl hover:bg-emerald-600/40 transition-all shadow-lg flex items-center justify-center gap-2 whitespace-nowrap"
                                        >
                                    ...
                                    <Link
                                        to="/contacto"
                                        className="px-8 py-4 bg-orange-600 text-white text-base font-bold rounded-xl hover:bg-orange-500 transition-all shadow-lg shadow-orange-600/20 whitespace-nowrap text-center flex items-center justify-center"
                                    >
                                        Contáctanos
                                    </Link>
                                </div>
