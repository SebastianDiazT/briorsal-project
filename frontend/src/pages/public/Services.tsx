            ...
            <div className="min-h-screen bg-[#1b252f] w-full flex flex-col lg:flex-row lg:items-center relative overflow-hidden font-sans selection:bg-orange-500/30 selection:text-orange-200">
                ...
                <div className="w-full lg:w-[40%] p-8 md:p-16 lg:p-24 flex flex-col justify-center z-10 relative self-center">
                    ...
                    <FadeIn direction="right" delay={0.2}>
                        <h1 className="text-5xl md:text-6xl xl:text-7xl font-black text-white leading-[0.9] tracking-tight mb-8 uppercase drop-shadow-lg">
                            Nuestros <br />
                ...
                <div className="w-full lg:w-[60%] p-6 md:p-12 lg:p-24 z-10">
                    ...
                    {!isLoading && services.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-20 text-slate-500">
                            ...
                            <p className="text-xl font-light uppercase tracking-widest italic text-center text-slate-400">
        ...
        {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex flex-col animate-pulse">
                ...
                <div className="space-y-2">
                    <div className="h-4 w-full bg-white/5 rounded-sm opacity-50"></div>
                    <div className="h-4 w-5/6 bg-white/5 rounded-sm opacity-50"></div>
                </div>
            </div>
        ))}
    </div>
